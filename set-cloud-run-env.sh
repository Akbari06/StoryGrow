...
gcloud run services update $SERVICE_NAME \
  --region=$REGION \
  --update-env-vars="GEMINI_API_KEY=AIzaSyAo3cTkISmK9GqBxt7wFlJABfWWlw51O_A,GCP_PROJECT_ID=storygrow-2,GCS_BUCKET_NAME=bucketstorygrow,GOOGLE_APPLICATION_CREDENTIALS=/app/service-account-key.json" \
  --service-account="storygrow-app@storygrow-2.iam.gserviceaccount.com"
